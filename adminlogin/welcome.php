...
if(isset($_POST['submit'])) {
    ...
    $html = "<table>
                <tr><td>FirstName: $name</td></tr>
                <tr><td>Mobile: $mobile</td></tr>
                <tr><td>Email: $email</td></tr>
                <tr><td>Type Of Waste: $chk</td></tr>
                <tr><td>Area: $location</td></tr>
                <tr><td>Area description: $locationdescription</td></tr>
                <tr><td>Images: $file</td></tr>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="contact-form">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="wastetype">Category:</label>
                            <div class="col-sm-10">          
                        ...
                        <div class="form-group">        
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <input type="hidden" class="form-control" id="date" name="date" value="<?php date_default_timezone_set("Asia/Kathmandu"); echo date("g:ia ,\n l jS F Y"); ?>">
